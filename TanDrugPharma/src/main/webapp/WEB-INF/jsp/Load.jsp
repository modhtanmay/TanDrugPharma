...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="btn btn-outline-light" class="nav-item nav-link active" href="load">Add</a>
...
<body style="background-color: #f1f3de">
	<h1 style="margin-top:70px; font-style:inherit; font-family:fantasy;" align="center">Medicine Stock Entry</h1>
<div align="center" class="container" style="background-color: #e0ece4; max-width:900px; height:420p; padding: 5%">	
	<form:form method="post" modelAttribute="medicine" action="loadMed">
		<table style="width:100%">
			...
			<tr>
				<td><input style="margin-top: 10px;margin-left: 265px" class="btn btn-warning" type="submit" value="Load" onclick="return confirm('Are you sure you want to Add Medicine?');" /></td>
			</tr>
		</table>
	</form:form>
</div>	
